...
// зарегистрированных 09.10.2021 и 10.10.2021). 
// Массив в task1.txt 

const userdata = users.filter(Date=>Date.registrationDate ==='10.10.2021'|| Date.registrationDate ==='09.10.2021' ) 
         console.log(userdata)



 function userdata(data1, data2){
    return users.filter(Date=> Date.registrationDate ==data1|| Date.registrationDate ==data2) 
 }
console.log(userdata('10.10.2021','09.10.2021'))
